...
public class PizzaCommand implements Command {
	...
	public static final String COMMAND_TEXT = "pizza";
	...
	public void executeCommand(LinkedList<String> args, MessageReceivedEvent event) {
		event.getTextChannel().sendFile(new File("C:\\Users\\Porvelm\\Desktop\\Auralann\\Text2Auralann\\Discord Bot\\Auracord\\pizza.jpg"), null);
	}
