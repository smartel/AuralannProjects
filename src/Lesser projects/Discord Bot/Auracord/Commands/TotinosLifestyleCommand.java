...
public class TotinosLifestyleCommand implements Command { // TOTINOS, TOTINOS

	public static final String COMMAND_TEXT = "lifestyle";
	...
	public void executeCommand(LinkedList<String> args, MessageReceivedEvent event) {
		...
		try {
			...
			if (vc != null) {
				...
				af = new File("C:\\Users\\Porvelm\\Desktop\\Auralann\\Text2Auralann\\Discord Bot\\Auracord\\lifestyle.mp3");
