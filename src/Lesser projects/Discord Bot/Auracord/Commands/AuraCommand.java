...
public class AuraCommand implements Command {

	public static final String COMMAND_TEXT = "auras";
	// ALT_TEXT: aura
	...
	public boolean called(LinkedList<String> args, MessageReceivedEvent event) {
		if (args.size() == 0) {
			event.getTextChannel().sendMessage("I need to know whether to turn auras On or Off, young one.");
			return false;
		} else if (args.size() == 1) {
