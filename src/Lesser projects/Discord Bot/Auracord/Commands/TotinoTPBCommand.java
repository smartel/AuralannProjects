...
public class TotinoTPBCommand implements Command { // Totino the Pizza Boy!

	public static final String COMMAND_TEXT = "ttpb";
	...
	public void executeCommand(LinkedList<String> args, MessageReceivedEvent event) {
		...
		try {
			...
			if (vc != null) {
				...
				af = new File("C:\\Users\\Porvelm\\Desktop\\Auralann\\Text2Auralann\\Discord Bot\\Auracord\\ttpb.mp3");
